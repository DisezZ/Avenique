...
class BalanceAllAccStatGraph extends StatefulWidget {
  const BalanceAllAccStatGraph({super.key});

  @override
  State<BalanceAllAccStatGraph> createState() => _BalanceAllAccStatGraphState();
}

class _BalanceAllAccStatGraphState extends State<BalanceAllAccStatGraph> {
  @override
...
class BalanceAccBarStatbox extends StatefulWidget {
  const BalanceAccBarStatbox({super.key});

  @override
  State<BalanceAccBarStatbox> createState() => _BalanceAccBarStatboxState();
}

class _BalanceAccBarStatboxState extends State<BalanceAccBarStatbox> {
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
...
class BalanceAllAccStatBar extends StatefulWidget {
  const BalanceAllAccStatBar({super.key});

  @override
  State<BalanceAllAccStatBar> createState() => _BalanceAllAccStatBarState();
}

class _BalanceAllAccStatBarState extends State<BalanceAllAccStatBar> {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: Padding(
        ...
        child: Container(
          ...
          child:
            ...
            const Padding(
                ...
                child: Text('Accounts', style: TextStyle(fontSize: 21))),
            Padding(
...
class BalanceAccsContainer extends StatefulWidget {
  const BalanceAccsContainer({super.key});

  @override
  State<BalanceAccsContainer> createState() => _BalanceAccsContainerState();
}

class _BalanceAccsContainerState extends State<BalanceAccsContainer> {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: Padding(
